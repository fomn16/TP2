...
/* package kwic-0.1.0.0 */
#define VERSION_kwic "0.1.0.0"
#define MIN_VERSION_kwic(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
...
#define CURRENT_COMPONENT_ID "kwic-0.1.0.0-MVrlSyVkNJB4HbN56Dkf9"

#define CURRENT_PACKAGE_KEY "kwic-0.1.0.0-MVrlSyVkNJB4HbN56Dkf9"
